// Reusable SVG icon components to reduce duplication
...
export function FilterIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 001.414 1.414l-.828.828A1 1 0 0020 8.586V7a1 1 0 112 0v3.414a1 1 0 001.414 1.414l-.828.828a1 1 0 00-.707-.293 17 17V4z" />
    </svg>
  )
}
